const IntrosuctionDoc = () => {
  return (
    <>
      <p className="mb-4">
        Welcome to the StoreOps API documentation. This API provides a
        comprehensive suite of endpoints designed to power e-commerce
        operations, enabling developers to create, manage, and interact with
        online stores efficiently.
      </p>

      <p className="mb-4">
        Our API offers functionality for managing various aspects of an
        e-commerce platform, including:
      </p>

      <ul className="list-disc list-inside mb-4">
        <li>Billboards for promotional content</li>
        <li>Products categories</li>
        <li>Product sizes and colors</li>
